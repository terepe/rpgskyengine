...
void ColorRGBToHLSi(int32 _R, int32 _G, int32 _B, int32 *_Hue, int32 *_Light, int32 *_Saturation)
{
	...
	if(_Hue)		*_Hue		= (int32)TClamp1(h*(256.0f/360.0f), 0.0f, 255.0f);
	if(_Light)		*_Light		= (int32)TClamp1(l*256.0f, 0.0f, 255.0f);
	if(_Saturation) *_Saturation= (int32)TClamp1(s*256.0f, 0.0f, 255.0f);
}
...
void ColorHLSToRGBi(int32 _Hue, int32 _Light, int32 _Saturation, int32 *_R, int32 *_G, int32 *_B)
{
	...
	if(_R) *_R = (int32)TClamp1(r*256.0f, 0.0f, 255.0f);
	if(_G) *_G = (int32)TClamp1(g*256.0f, 0.0f, 255.0f);
	if(_B) *_B = (int32)TClamp1(b*256.0f, 0.0f, 255.0f);
}
