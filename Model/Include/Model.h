...
enum E_MODEL_RENDER_TYPE
{
	...
	MODEL_RENDER_MESH_BUMP		= 1<<3,
	MODEL_RENDER_PARTICLES_ALPHATEST= 1<<4,
	MODEL_RENDER_PARTICLES_ALPHA= 1<<5,
	MODEL_RENDER_PARTICLES_GLOW	= 1<<6,
	MODEL_RENDER_MESH_NORMAL	= MODEL_RENDER_MESH_GEOMETRY+MODEL_RENDER_MESH_ALPHA+MODEL_RENDER_MESH_GLOW,
	MODEL_RENDER_PARTICLES_NORMAL= MODEL_RENDER_PARTICLES_ALPHATEST+MODEL_RENDER_PARTICLES_ALPHA+MODEL_RENDER_PARTICLES_GLOW,
	MODEL_RENDER_NORMAL			= MODEL_RENDER_MESH_NORMAL+MODEL_RENDER_PARTICLES_NORMAL,
	MODEL_RENDER_MESH			= MODEL_RENDER_MESH_NORMAL+MODEL_RENDER_MESH_BUMP,
	MODEL_RENDER_PARTICLES		= MODEL_RENDER_PARTICLES_NORMAL,
...
struct CMaterial
{
	...
	E_MODEL_RENDER_TYPE getModelRenderType();
