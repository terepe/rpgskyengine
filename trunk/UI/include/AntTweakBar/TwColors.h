...
template <typename _T> inline const _T& TClamp1(const _T& _X, const _T& _Limit1, const _T& _Limit2)
{
	if(_Limit1<_Limit2)
...
{
	return (((color32)TClamp1(_A, 0, 255))<<24) | (((color32)TClamp1(_R, 0, 255))<<16) | (((color32)TClamp1(_G, 0, 255))<<8) | ((color32)TClamp1(_B, 0, 255));
}

inline color32 Color32FromARGBf(float _A, float _R, float _G, float _B)
{
	return (((color32)TClamp1(_A*256.0f, 0.0f, 255.0f))<<24) | (((color32)TClamp1(_R*256.0f, 0.0f, 255.0f))<<16) | (((color32)TClamp1(_G*256.0f, 0.0f, 255.0f))<<8) | ((color32)TClamp1(_B*256.0f, 0.0f, 255.0f));
}
